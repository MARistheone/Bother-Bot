# AGENTS.md - Bother Bot

> Cross-platform agent instructions. Read by Claude Code, Google Antigravity, Cursor, and any AGENTS.md-compatible tool.
...
| Command | Description |
|---------|-------------|
| `/opt-in` | Register user, create private channel, set score to 0 |
| `/task add [description] [due_date] [recurrence]` | Add a new task |
| `/prod [user]` | Public reminder for user's overdue tasks |
| `/board` | Force redraw of #accountability-board (admin) |
| `/set-meat-grinder` | Set current channel as the celebration/shame channel (admin) |
